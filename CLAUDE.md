...
**YOU ARE IN: `paintball/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/paintball/` (rig root) or other directories
...
**Your mail address:** `paintball/polecats/chrome`
**Your rig:** paintball
**Your Witness:** `paintball/witness`
...
| Ask Witness for help | `gt mail send paintball/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`paintball/witness`) when:
...
```bash
gt mail send paintball/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
